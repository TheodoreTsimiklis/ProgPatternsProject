...
public class StudentsController {
    ...
    StudentsModel currentStudent;

    public StudentsController(StudentsModel currentStudent) {
    ...
    public void viewCatalogue() {
        try {
            ...
            query = "SELECT I.SERIALNUMBER, B.SERIALNUMBER, B.TITLE, I.ISSUEDATE, I.RETURNDATE "
                    + "FROM ISSUEDBOOKS I, BOOKS B WHERE I.SERIALNUMBER = B.SERIALNUMBER";
